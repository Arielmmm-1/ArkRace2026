...
void main(void)
{
    ...
    while(1)
    {
        /* 示例：每隔 1 s 做一次 0°→90°→180°→90° 摆动 */
        set_servo_angle(0, 180);    Delay_ms(1000);
        set_servo_angle(90, 180);   Delay_ms(1000);
        set_servo_angle(180, 180);  Delay_ms(1000);
        set_servo_angle(90, 180);   Delay_ms(1000);
    }
}
